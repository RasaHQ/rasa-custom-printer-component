...
scratch. In this document we will keep it relatively simple. We're 
going to create a `Printer` component that will print all the features
that the pipeline has created. This will allow us to appreciate how 
